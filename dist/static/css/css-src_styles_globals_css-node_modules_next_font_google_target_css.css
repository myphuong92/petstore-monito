...
.outline-btn {
  ...
  border-style: solid;
  --tw-border-opacity: 1;
  border-color: rgb(0 52 89 / var(--tw-border-opacity));
  padding-top: 0.5rem;
  padding-bottom: 0.5rem;
  padding-left: 1.25rem;
  padding-right: 1.25rem;
  --tw-text-opacity: 1;
  color: rgb(0 52 89 / var(--tw-text-opacity));
}
.outline-btn-white {
  display: flex;
  align-items: center;
...
.primary-color-btn {
  border-radius: 9999px;
  --tw-bg-opacity: 1;
  background-color: rgb(0 52 89 / var(--tw-bg-opacity));
  padding-top: 0.5rem;
  padding-bottom: 0.5rem;
  padding-left: 1.25rem;
  padding-right: 1.25rem;
...
.text-heading-color {
  --tw-text-opacity: 1;
  color: rgb(0 23 31 / var(--tw-text-opacity));
}
.text-content-color {
  --tw-text-opacity: 1;
  color: rgb(102 116 121 / var(--tw-text-opacity));
}
.bg-primary-color {
  --tw-bg-opacity: 1;
  background-color: rgb(0 52 89 / var(--tw-bg-opacity));
...
.dark-blue-80 {
  --tw-text-opacity: 1;
  color: rgb(0 42 72 / var(--tw-text-opacity));
}
.solid {
...
.bg-\[\#FCEED5\] {
  --tw-bg-opacity: 1;
  background-color: rgb(252 238 213 / var(--tw-bg-opacity));
}
.bg-\[\#FF564F\] {
  --tw-bg-opacity: 1;
  background-color: rgb(255 86 79 / var(--tw-bg-opacity));
}
.bg-\[\#FFB672\] {
  --tw-bg-opacity: 1;
  background-color: rgb(255 182 114 / var(--tw-bg-opacity));
}
.bg-\[\#FFF7CE\] {
  --tw-bg-opacity: 1;
  background-color: rgb(255 247 206 / var(--tw-bg-opacity));
}
.bg-blue-500 {
  --tw-bg-opacity: 1;
...
.text-\[\#CCD1D2\] {
  --tw-text-opacity: 1;
  color: rgb(204 209 210 / var(--tw-text-opacity));
}
.text-gray-500 {
  --tw-text-opacity: 1;
...
body {
    ...
    /* min-width: 100vh; */
    width: 100%;
    /* prevent the user from scrolling horizontally */
    max-width: 100%;
    overflow-x: hidden;
    /* overflow-y:scroll; */
...
.screen {
    ...
    margin: var(--nav-height) auto 0px auto;
